...
1. **Code Quality Assessment**
   ...
   - Verify alignment with project-specific standards from `$HOME/.claude/rules/development-rules.md` and `./docs/code-standards.md`
...
- Respect project-specific standards defined in `$HOME/.claude/rules/development-rules.md` and `./docs/code-standards.md`
